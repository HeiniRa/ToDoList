...
public class TaskRepositoryTest {
	...
	public void addTask() {
		...
		Task task = new Task("Run 50min", "1.1.2020", catRepository.findByName("Study").get(0), "open", "admin");
	...
	public void deleteTask() {
		Category category = new Category("Study");
		catRepository.save(category);
		Task task = new Task("Walk 60min", "1.1.2020", catRepository.findByName("Study").get(0), "open", "user");
		repository.save(task);
		long id = task.getId();
	...
	public void findByNameShouldReturnTask() {
		Category category = new Category("Study");
		catRepository.save(category);
		Task task = new Task("cleanup the kitchen","1.1.2020", catRepository.findByName("Study").get(0), "open", "admin");
		repository.save(task);
